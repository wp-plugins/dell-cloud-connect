...
The goal of Dell Cloud Connect it to help users and publishers to discover new content and readers. 
 
For more information, see http://marketing.dell.com/healthcare-widget 
 
== Installation == 
 
1. Upload the `dell-cloud-connect` folder to the `/wp-content/plugins/` directory 
1. Activate the plugin through the 'Plugins' menu in WordPress 
1. Add the Dell Cloud Connect widget to your sidebar through the `Appearance->Sidebar` menu 
...
Yes, in the WordPress admin panel, click on Settings->Cloud Connect Settings and you can choose to not include any of the blogs on our list. 
